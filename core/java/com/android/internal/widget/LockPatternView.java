...
public class LockPatternView extends View {
    ...
    /* Index of the cell with current focus. -1 or dot count if no cell is focused */
    ...
    public static final class Cell {
        ...
        public static Cell of(int row, int column) {
            return of(row, column, LockPatternUtils.PATTERN_SIZE_DEFAULT);
        }
    ...
    private boolean isPatternFull() {
        return mPattern.size() == getDotCount();
    }

    private int getDotCount() {
        return mPatternSize * mPatternSize;
    }
    ...
    private void addCellToPattern(Cell cell) {
        ...
        if (mClickInputSupported) {
            final int virtualViewId =
                    VIRTUAL_BASE_VIEW_ID + cell.row * mPatternSize + cell.column;
    ...
    private boolean isCellIndexInRange(int index) {
        return index >= 0 && index < getDotCount();
    }
    ...
    private boolean isCellIndexPartOfPattern(int index) {
        ...
        return mPatternDrawLookup[index / mPatternSize][index % mPatternSize];
    }
        ...
        if (gainFocus) {
            ...
            switch (direction) {
                ...
                case FOCUS_BACKWARD, FOCUS_UP, FOCUS_LEFT -> {
                    mFocusedCellIndex = getDotCount() - 1;
        ...
        if (keyCode == KeyEvent.KEYCODE_TAB
            ...
            switch (keyCode) {
                ...
                case KeyEvent.KEYCODE_DPAD_LEFT, KeyEvent.KEYCODE_DPAD_RIGHT -> {
                    ...
                    if ((mFocusedCellIndex / mPatternSize) != (next / mPatternSize)) {
                        next = -1;
                    }
                }
                case KeyEvent.KEYCODE_DPAD_UP, KeyEvent.KEYCODE_DPAD_DOWN -> {
                    next = findNextFocusableCell(mFocusedCellIndex,
                            keyCode == KeyEvent.KEYCODE_DPAD_UP ? -mPatternSize : mPatternSize,
                            true);
                }
                default -> {
                    next = -1;
    ...
    private boolean handleActionKeyboard(int index) {
        ...
        final float x = getCenterXForColumn(index % mPatternSize);
        final float y = getCenterYForRow(index / mPatternSize);
    ...
    private void handleActionMouseUp(float x, float y) {
        ...
        if (hitCell != null) {
            ...
            notifyPatternDetected();
            mFocusedCellIndex = (hitCell.row * mPatternSize) + hitCell.column;
        ...
        if (mVisibleDots) {
            for (int i = 0; i < mPatternSize; i++) {
                ...
                for (int j = 0; j < mPatternSize; j++) {
                    ...
                    // Draw focus ring.
                    if (!mInStealthMode && mFocusVisible
                            && (i * mPatternSize) + j == mFocusedCellIndex) {
                        final float radius =
                                (mDotSize / 2f) + FOCUS_RING_GAP + (FOCUS_RING_WIDTH / 2f);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        return new SavedState(superState,
                ...
                mPatternSize, mInputEnabled, mInputMode.ordinal(),
                mInStealthMode, mPatternInProgress, mVisibleDots, mShowErrorPath);
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setLockPatternSize(ss.getPatternSize());
        setPattern(
                DisplayMode.Correct,
    ...
    private static class SavedState extends BaseSavedState {
        ...
        private SavedState(Parcelable superState, String serializedPattern, int displayMode,
                ...
                boolean inStealthMode, boolean patternInProgress, boolean visibleDots,
                boolean showErrorPath) {
            super(superState);
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        protected void getVisibleVirtualViews(IntArray virtualViewIds) {
            ...
            for (int i = VIRTUAL_BASE_VIEW_ID; i < VIRTUAL_BASE_VIEW_ID + getDotCount(); i++) {
        ...
        private Rect getBoundsForVirtualView(int virtualViewId) {
            ...
            final int row = ordinal / mPatternSize;
            final int col = ordinal % mPatternSize;
        ...
        private int getVirtualViewIdForHit(float x, float y) {
            ...
            int dotId = (cellHit.row * mPatternSize + cellHit.column) + VIRTUAL_BASE_VIEW_ID;
